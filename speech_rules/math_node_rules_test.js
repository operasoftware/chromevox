...
goog.provide('cvox.MathNodeRulesTest');
 ...
 */
cvox.MathNodeRulesTest = function() {
  goog.base(this);
};
goog.inherits(cvox.MathNodeRulesTest, cvox.AbstractTestCase);
 ...
 * @override
 */
cvox.MathNodeRulesTest.prototype.setUpTest = function() {
  cvox.MathNodeRules.getInstance();
  this.rules = cvox.MathNode.getInstance();
  this.nodeCounter = 0;
};
 ...
 */
cvox.MathNodeRulesTest.prototype.executeRuleTest = function(html, ruleName) {
  ...
  var atom = this.rules.retrieveAtom(node.childNodes[0]);
  this.assertEquals(ruleName, atom['key']);
};
 ...
 * @export
 */
cvox.MathNodeRulesTest.prototype.testMathmlEmptyRules = function() {
 ...
 * @export
 */
cvox.MathNodeRulesTest.prototype.testMathmlTokenRules = function() {
 ...
 * @export
 */
cvox.MathNodeRulesTest.prototype.testMathmlFontRules = function() {
 ...
 * @export
 */
cvox.MathNodeRulesTest.prototype.testMathmlScriptRules = function() {
 ...
 * @export
 */
cvox.MathNodeRulesTest.prototype.testMathmlLayoutRules = function() {
 ...
 * @export
 */
cvox.MathNodeRulesTest.prototype.testMathmlSpecializationRules = function() {
 ...
 * @export
 */
cvox.MathNodeRulesTest.prototype.testMathmlMfencedRules = function() {
 ...
 * @export
 */
cvox.MathNodeRulesTest.prototype.testMathmlMtableRules = function() {
 ...
 * @export
 */
cvox.MathNodeRulesTest.prototype.testMathmlMultiscriptRules = function() {
