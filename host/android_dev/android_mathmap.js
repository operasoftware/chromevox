...
cvox.AndroidMathMap.prototype.speak = function(text, type, alt, rule, domain) {
  ...
  if (result) {
    return new cvox.NavDescription({text: result.mappingString(domain, rule)});
    }
