...
cvox.CommandStore.store_ = [
  ...
  ['previousWord', 'previous_word', 'chromevox_navigation'],
  ['nextWord', 'next_word', 'chromevox_navigation'],
  ['previousLine', 'previous_line', 'chromevox_navigation'],
  ['nextLine', 'next_line', 'chromevox_navigation'],
  ['previousSentence', 'previous_sentence', 'chromevox_navigation'],
  ['nextSentence', 'next_sentence', 'chromevox_navigation'],
  ['previousObject', 'previous_object', 'chromevox_navigation'],
  ['nextObject', 'next_object', 'chromevox_navigation'],
  ['previousGroup', 'previous_group', 'chromevox_navigation'],
  ['nextGroup', 'next_group', 'chromevox_navigation'],
